...
{
    public class NodeCreateLaser : BaseNode
    {
        public override void Init(RectTransform parentTf)
        {
            _nodeType = NodeType.CreateCustomizedLaser;
            base.Init(parentTf);
        ...
        {
            return string.Format("create laser of type\"{0}\" at ({1},{2}) with parameter {3}",
        ...
        public override string ToLuaHead()
        {
            ...
            return string.Format("last = CreateCustomizedLaser(\"{0}\",{1},{2}{3})\n",
                typeName,
