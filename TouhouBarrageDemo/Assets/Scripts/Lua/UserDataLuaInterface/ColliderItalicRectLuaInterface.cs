...
public class ColliderItalicRectLuaInterface
{
    ...
    public static bool Set(object o, TValue key, ref TValue value)
    {
        ...
        value.SetSValue(string.Format("SetField of userData fail!Invalid key {0} for type {1}", key, typeof(ColliderItalicRect).Name));
        return false;
    }
}