...
public class Reimu : CharacterBase
{
    ...
    public override void Init()
    {
        ...
        _subPosOffset[index][2] = new Vector2[] { new Vector2(-20f, 4f), new Vector2(0f, 28f), new Vector2(20f, 4f) };
        _subPosOffset[index][3] = new Vector2[] { new Vector2(-20f, 4f), new Vector2(-8f, 28f), new Vector2(8f, 28f), new Vector2(20f, 4f) };
        _isSubMoving = false;
